...
const BoxView = ({ files, ShowDetails, reloadFiles, setReloadFiles }) => {
  const [cacheBuster, setCacheBuster] = useState('');

  useEffect(() => {
    if (reloadFiles) {
      // Force cache busting by updating the timestamp
      setCacheBuster(`?t=${Date.now()}`);
      setReloadFiles(false);
    }
  }, [reloadFiles, setReloadFiles]);
