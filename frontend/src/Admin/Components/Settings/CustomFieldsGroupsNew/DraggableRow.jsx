    ...
    <>
      ...
      >
        <tr>
          <td className="flex items-center gap-2">
            ...
            {expandedIndex === idx ? (
              <svg
                ...
                width="200px"
                xmlns="http://www.w3.org/2000/svg"
                className="custom-fields-chevron w-4 h-4"
          ...
          <td className="text-blue-500">{field.label}</td>
          <td>{field.name}</td>
          <td>{field.type}</td>
        </tr>
        <tr className={expandedIndex === idx ? '' : 'hidden'}>
          <td colSpan="4" className="border-l-4 border-l-blue-400 px-4 pt-4">
            <p>Type</p>
            <TypeSelect type={field.type} setType={updateFieldType} field={field} isUpdate={true} />
            {field.type && (
              <FieldData
                type={field.type}
                fieldData={field}
