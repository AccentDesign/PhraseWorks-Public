  ...
  return (
    ...
    >
      <SortableContext items={fields.map((f) => f.order)} strategy={verticalListSortingStrategy}>
        <table className="w-full table-auto text-sm text-left rtl:text-right text-gray-500 mt-4">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50">
            <tr>
              <th className="py-2 px-4 w-[10%]">#</th>
              <th className="py-2 px-4 w-[30%]">Label</th>
              <th className="py-2 px-4 w-[30%]">Name</th>
              <th className="py-2 px-4 w-[30%]">Type</th>
            </tr>
          </thead>
