...
const Page = ({
  ...
  return (
    <div>
      <h2 className="seo-settings-header">Page</h2>
      ...
      <div className="w-full mb-4">
        ...
        <PillTextBox value={pageSEOTitle} setValue={setPageSEOTitle} variables={pillOptions} />
      </div>
      <div className="w-full mb-4">
      ...
      <div className="w-full mb-4">
        ...
        <PillTextBox
          value={pageSocialTitle}
          setValue={setPageSocialTitle}
          variables={pillOptions}
        />
      </div>
      <div className="w-full mb-4">
        ...
        <PillTextArea
          value={pageSocialDescription}
          setValue={setPageSocialDescription}
          variables={pillOptions}
        />
      </div>
      <button
