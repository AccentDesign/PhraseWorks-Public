...
const SelectMultipleField = ({ selectMultiple, setSelectMultiple }) => {
  return (
    <>
      <div className="mb-4">
        ...
        after:rounded-full after:h-5 after:w-5 after:transition-all"
          ...
          <div className="flex flex-col">
            <span className="ms-3 text-sm font-medium text-gray-900">Select Multiple</span>
            <p className="ms-3 text-sm text-gray-500">
              Allow content editors to select multiple values
            </p>
          </div>
        </label>
      </div>
