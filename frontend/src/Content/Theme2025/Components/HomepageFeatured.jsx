  ...
  return (
    <div className="my-10">
      ...
      <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">
        Everything you need to create a website easilly with interchangeable plugins and themes.
      </p>

      <div className="flex items-center justify-center flex-wrap gap-6 mt-10 px-4 md:px-0">
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 gap-6 max-w-sm">
          ...
          <div className="space-y-2">
            <h3 className="text-base font-semibold text-slate-700">Creating posts and pages</h3>
            <p className="text-sm text-slate-600">
              Create posts, pages and custom posts along with custom fields and forms for your site
            </p>
          </div>
        </div>
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 gap-6 max-w-sm">
          ...
          <div className="space-y-2">
            <h3 className="text-base font-semibold text-slate-700">Security and Caching</h3>
            <p className="text-sm text-slate-600">
              Modern security, logins and redis caching by default.
            </p>
          </div>
        </div>
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 gap-6 max-w-sm">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-600">
              The theme can be amended to modify output and allows swapping of components as needed,
              all using React and Tailwind 4.
            </p>
          </div>
        </div>
      </div>
