...
import { APIAddNotificationGForm, APIGetGForm, APIUpdateGForm } from '../../API/APIForms';
...
const FormSettingsNotificationsNewPageContent = () => {
  ...
  const saveNotification = async () => {
    const data = await APIAddNotificationGForm(
      loginPassword,
      id,
      notificationName,
      notificationSendTo,
    ...
    if (data.status == 200) {
      if (data.data.addGFormNotification.success) {
...
export default FormSettingsNotificationsNewPageContent;
